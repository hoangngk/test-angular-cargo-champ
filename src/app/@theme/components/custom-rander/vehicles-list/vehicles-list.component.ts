...
import { AddComponent } from '../../../../main/vehicles/modal/add/add.component';

@Component({
  selector: 'ngx-vehicles-list',
  templateUrl: './vehicles-list.component.html',
  styleUrls: ['./vehicles-list.component.scss']
})
export class VehiclesListComponent implements ViewCell, OnInit, OnDestroy {
  ...
  deleteClicked(id: string) {
    this.ms.deleteData(id).subscribe(data => {
      ...
      this.toastrService.success('Vehicles deleted succefully. ', 'Delete', { duration: 4000 });
    }, error => {
