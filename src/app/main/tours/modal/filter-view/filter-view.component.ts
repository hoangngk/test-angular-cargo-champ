...
import { settingsEN, settingsDE, settingsColumn } from '../../../../../assets/i18n/column-setting-tours.constant';
...
export class FilterViewComponent implements OnInit {
  ...
  hideColumnArray = [];
  ngOnInit(): void {
    this.hideColumnArray = JSON.parse(localStorage.getItem('hideColumnTours')) || [];
  }
  ...
  constructor(protected ref: NbDialogRef<FilterViewComponent>, private as: AuthService, public ts: ToursService) {
  ...
  apply() {
    localStorage.setItem('hideColumnTours', JSON.stringify(this.hideColumnArray));
