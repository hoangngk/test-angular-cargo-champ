...
import { settingsEN, settingsDE } from '../../../../assets/i18n/column-setting-trailers.constant';
...
export class TrailersGroupCellRenderComponent implements ViewCell, OnInit {
